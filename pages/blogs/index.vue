...
export default {
  ...
  methods: {
    async loadBlog(LoadData = 0) {
      ...
      await this.$store.dispatch('home/fetchBlogPosts', {limit: paginate})
      this.posts = this.$store.state.home.BLOG_POSTS.posts
      this.paginate = this.posts.length
      this.totalblog = this.$store.state.home.BLOG_POSTS.dataInfo.total_count
