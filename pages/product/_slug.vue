    ...
    <div v-else>
      ...
      <section class="product-page-wrapper clear-cache">
        ...
        <div class="container">
          ...
          <div class="pd-pg-top-content">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4 col-xl-5">
                ...
                <add-cart-info :simple_info="simple_info"
                               :info="info"
                               :emi_widget="emi_widget"
                               :toggleReviewsDrawer="toggleReviewsDrawer"
                               :quantityDecreament="quantityDecreament"
                               :quantityIncreament="quantityIncreament"
                               :addToCart="addToCart"
                               :oneClickBuyNow="oneClickBuyNow"
                               :qty="quantity"
                               @set-variation-id="getSelectedVariationId"
                ...
                <div v-if="info" class="pd-pg-details-tab">
                  <ul>
                    ...
                    <!-- <li @click="toggleCareInfoDrawer()">
                        <button>
                        <span class="pd-details-title">
                        <span class="title">Care Information</span>
                        </span>
                        <span class="pd-details-icon">
                        <i class="fas fa-chevron-right"></i>
                        </span>
                    ...
                    <li @click="toggleReviewsDrawer()">
                      <button>
                                        ...
                                        <span class="pd-details-icon">
                                          <span class="product-review-star d-inline-block px-1" v-for="n in 5">
          ...
          <similar-product :products="similar_products" :key="1" classList="inview-similar-products"
                           v-view.once="similarProductViewHandler" />
          <!-- <similar-product :products="recent_view_products" :key="1" title="Your Recent Views"/> -->
        ...
        <div v-if="cart_add_success">
          <div class="left-content-product row">
            <div class="content-product-left col-md-12 col-sm-12 col-xs-12">
              <div class="row">
                <div class="col-md-12">
                  <h4 class="title-area-cart-v"> {{ cartAdded.total_qty }} new item have been added to your cart</h4>
                </div>
                <div class="col-md-4">
                  <div class="cart-img">
        ...
        <div v-else>
          ...
          <!-- <div class="left-content-product row">
              <div class="content-product-left col-md-7 col-sm-12 col-xs-12">
                  <div class="row">
                      <div class="col-md-12">
                          <h4 class="title-area-cart-v">  new item have been added to your cart</h4>
                      </div>
                      <div class="col-md-4">
                          <div class="cart-img">
                              <a href="javascript:void(0)">
                      ...
                      <div class="col-md-8">
                          <div class="content-product-right_wp">
                              <div class="cart-prouct-title">
                                  <h1>Metal Bed</h1>
                              </div>
                              <div class="product-label form-group">
                                  <div class=" price">{{money_sign}} 90000</div>
                              </div>
                          </div>
                      </div>
                  </div>
              ...
              <div class="col-md-5 col-sm-12 col-xs-12">
                  <div class="row">
                      <div class="col-md-12">
                          <h4 class="title-area-cart">My Shopping Cart <span class="total-item-list-a"> (4 items)</span></h4>
                      </div>
                      <div class="col-md-12">
                          <div class="title-product">
                              <ul>
                                  <li>Subtotal <span class="badge">{{money_sign}} 90000</span></li>
                                  <li class="top-banner-cart">Total <span class="badge">{{money_sign}} 90000</span></li>
                              </ul>
                          </div>
                      </div>
                      <div class="col-md-12 product_btnd">
                          <a href="javascript:void(0)" @click="closeModal" class="bk-btnc text-right">
                              <i class="icon-left-open"></i>
                              <span>Continue Shopping</span>
                          </a>
                          <a href="javascript:void(0)" @click="viewCartPage" class="view_one btn pull-right font-weight-bold common-btn_color">View Cart</a>
                      </div>
                  </div>
              </div>
          </div> -->
                  ...
                  <div class="col-md-12">
                    ...
                    <div v-else>
                      <div class="form-group">
                        ...
                        <input type="text" name="customer_name" id="" v-model="customerName" class="form-control"
                               required>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="customer_phone" id="" min="11" v-model="customerPhone"
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" name="customer_email" id="" v-model="customerEmail" class="form-control"
                               required>
                      </div>
                      <div class="form-group">
                        <label for="">Address</label>
                        <input type="text" name="customer_address" id="" v-model="customerAddress" class="form-control"
                               required>
                      </div>
                      <div class="form-group">
                        <button
              ...
              <div class="user-comment-answer">
                ...
                <div v-if="question.answers.length">
                  <span v-for="(ans,ansKey) in question.answers" :key="ansKey"
                        class="cmnt-ans-txt d-block"><b>Answer :</b> {{ ans.description }} </span>
                </div>
              </div>
      ...
      <right-drawer :openRequest="reviewsDrawer" width="40%" class="review-wrap">
        ...
        <div class="review-right-content">
          <!-- <div class="customer-ratingAnswer-wrap">
              <div class="customer-ratings-wrap">
                  <h3 class="customer-review-title">What Customers Said</h3>
              </div>
              <div class="customer-answer-wrap fit">
                  <div>Fit</div>
                  <div class="customer-answer-point">
                      <div class="answer-fill-wrap">
                          <div class="answer-fill" style="width: 81%;"></div>
                      </div>
                      <div class="answer-caption-wrap">As Expected (81%)</div>
                  </div>
              </div>
              <div class="customer-answer-wrap length">
                  <div>Length</div>
                  <div class="customer-answer-point">
                      <div class="answer-fill-wrap">
                          <div class="answer-fill" style="width: 85%;"></div>
                      </div>
                      <div class="answer-caption-wrap">As Expected (85%)</div>
                  </div>
              </div>
         </div> -->
          ...
          <div class="user-reviews-wrap-container">
            ...
            <div class="headings d-flex justify-content-between align-items-center mb-3">
              ...
              <div class="buttons">
                <nuxt-link :to="'/user/orders/'" class="badge bg-dark d-flex flex-row align-items-center p-2">
            ...
            <div class="review-box">
              <div v-for="review in allReviews" class="card p-3 mb-2">
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <span>
                      <small class="font-weight-bold text-secondary"> {{ review.user.name }} </small>
            ...
            <div v-if="info" class="show-more-review_btn">
              ...
              <!--              <nuxt-link :to="'/product/review/'+info.id">View all reviews</nuxt-link>-->
            </div>
          </div>
        </div>
      </right-drawer>
...
//    add to cart
  ...
  created() {
    const self = this
    //console.log(self.$store.state.product.INFO.product.id)
    if (self.$store.state.product.INFO.product && self.$store.state.product.INFO.product.id) {

      //console.log('product',self.$store.state.product.INFO.product)

      const product = self.$store.state.product.INFO.product,
        simple_product = self.$store.state.product.SIMPLE_INFO.product,
        dataOfLayer = {
          event: 'view_item',
          ecommerce: {
            ...
            items: [{
              ...
              item_id: product.product_code.toLocaleString(),
              affiliation: 'MasterLeatherBD',
              currency: 'BDT',
              price: parseFloat(simple_product.price_now),
              item_brand: 'MasterLeatherBD',
              item_category: product.categories && product.categories.length > 0 ? product.categories[0].term_name : 'Furniture',
              quantity: parseInt(1),
              discount: 0.00,
              index: 0,
              item_variant: 'regular',
              location_id: 'L_12345',
              item_list_id: product.product_code.toLocaleString(),
              item_list_name: product.sub_title,
              coupon: ''
            }]
          }
        }
      //console.log(product.categories && product.categories.length > 0 ? product.categories[0].term_name : 'Furniture')
      self.$gtm.push(dataOfLayer)
      //console.log('oldprice',simple_product , self.$gtm, dataLayer, dataOfLayer)
